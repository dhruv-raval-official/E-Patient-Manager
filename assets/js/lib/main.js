...
var Main = function() {
    ...
    var settingsHandler = function() {
        ...
        $('#skin_color').attr("href", "../assets/css/lib/" + appSetting.theme + ".css");
        ...
        $('input[name="setting-theme"]').change(function() {
            ...
            $('#skin_color').attr("href", "../assets/css/lib/" + selectedTheme + ".css");
        ...
        function defaultSetting() {
            ...
            $('#skin_color').attr("href", "../assets/css/lib/theme-1.css");
            $(".navbar-brand img").attr("src", "assets/images/logo.png");
